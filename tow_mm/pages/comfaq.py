...
from tow_mm.navigation_utils import nav_to_page, nav_to_com_faq
...
def display_com_faq(entry_id: Optional[int] = None):
    ...
    if entry_id is not None:
        st.title(f"Community FAQ, entry {entry_id}")
        ...
        if st.button("Back to Comfaq"):
            nav_to_com_faq(report_id=None)
    else:
        ...
        for idx, row in filtered_df.iterrows():
            ...
            link = f"{st.session_state.config.app_url}/?page=com_faq&id={row.ID}"
